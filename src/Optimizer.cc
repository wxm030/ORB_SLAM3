        ...
        for (KeyFrame *pKFi : vpAdjustKF)
        {
            ...
            if (dist > 1.0)
            {
                if (bShowImages)
                {
                    ...
                    for (int i = 0; i < (int)vpMonoMPsOpt.size(); ++i)
                    {
                    ...
                    for (int i = 0; i < (int)vpStereoMPsOpt.size(); ++i)
                    {
                    ...
                    for (int i = 0; i < int(vpMonoMPsBad.size()); ++i)
                    {
                    ...
                    for (int i = 0; i < int(vpStereoMPsBad.size()); ++i)
                    {
