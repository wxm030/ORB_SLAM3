...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        inline Eigen::Vector3d World2Camera(const Eigen::Vector3d &p_w, const Sophus::SE3 &T_c_w) const
        {
            return T_c_w * p_w;
        }

        inline Eigen::Vector3d Camera2World(const Eigen::Vector3d &p_c, const Sophus::SE3 &T_c_w) const
        {
            return T_c_w.inverse() * p_c;
        }

        inline Eigen::Vector2d Camera2Pixel(const Eigen::Vector3d &p_c) const
        {
        ...
        inline Eigen::Vector3d Pixel2Camera(const Eigen::Vector2d &p_p, float depth = 1) const
        {
        ...
        inline Eigen::Vector3d Pixel2World(const Eigen::Vector2d &p_p, const Sophus::SE3 &T_c_w, float depth = 1) const
        {
            return Camera2World(Pixel2Camera(p_p, depth), T_c_w);
        }

        inline Eigen::Vector2d World2Pixel(const Eigen::Vector3d &p_w, const Sophus::SE3 &T_c_w) const
        {
    ...
    public:
        ...
        static cv::Mat map1, map2;   // for undistortion
